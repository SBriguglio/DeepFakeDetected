...
in_path="/home/brigugls/repositories/University_Repos/CourseWork/8700Project_DeepFakeDetection/DeepFakeDetected/DeepFakeDetected/resources/DeepfakeTIMIT/DeepfakeTIMIT/higher_quality/"
...
for DIR in */; do
  ...
  for FILE in *.avi; do
    ...
    ffmpeg -i "$FILE" -r 25 -f image2 $out_path/"$newname"%07d.png;
  done
done
